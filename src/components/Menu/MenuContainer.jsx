...
const MenuContainer = ({ menus = [] }) => {
  ...
  if (!Array.isArray(menuArray) || menuArray.length === 0) {
    return (
      <div className="pos-card pos-p-6">
        <h3 className="pos-heading-tertiary pos-text-gray-600 mb-2">Menu data not loaded</h3>
        <p className="pos-body-small pos-text-gray-400">No categories were found in the Redux menu slice. Check that the store is configured properly.</p>
      </div>
    );
  }
