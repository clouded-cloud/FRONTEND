                ...
                itemsData.map((item, index) => {
                    return (
                        ...
                        <div className="flex justify-between items-center">
                          ...
                          <div className="flex items-center gap-1">
                            <svg className={`w-3 h-3`} viewBox="0 0 24 24" stroke="currentColor" strokeWidth="4" fill="none" style={{ color: item.isIncrease ? "#f5f5f5" : "red" }}>
                              <path d={item.isIncrease ? "M5 15l7-7 7 7" : "M19 9l-7 7-7-7"} />
                            </svg>
                            <p className={`font-medium text-xs`} style={{ color: item.isIncrease ? "#f5f5f5" : "red" }}>{item.percentage}</p>
                          </div>
                        </div>
