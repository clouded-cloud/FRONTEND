...
const Home = () => {
  ...
  return (
    <div className="p-6 bg-[#1f1f1f] min-h-screen text-[#f5f5f5]">
      <div className="max-w-7xl mx-auto">
        <Greetings />

        {/* Stats Cards */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-[#1a1a1a] p-6 rounded-lg shadow-md border border-[#383737] border-l-4 border-green-500">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-[#ababab] text-sm font-medium">Total Earnings</p>
                <p className="text-2xl font-bold text-[#f5f5f5]">KSH{totalEarnings || 512}</p>
          ...
          <div className="bg-[#1a1a1a] p-6 rounded-lg shadow-md border border-[#383737] border-l-4 border-blue-500">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-[#ababab] text-sm font-medium">In Progress</p>
                <p className="text-2xl font-bold text-[#f5f5f5]">{inProgressOrders || 16}</p>
          ...
          <div className="bg-[#1a1a1a] p-6 rounded-lg shadow-md border border-[#383737] border-l-4 border-yellow-500">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-[#ababab] text-sm font-medium">Active Tables</p>
                <p className="text-2xl font-bold text-[#f5f5f5]">{activeTables || 8}</p>
          ...
          <div className="bg-[#1a1a1a] p-6 rounded-lg shadow-md border border-[#383737] border-l-4 border-purple-500">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-[#ababab] text-sm font-medium">Today's Orders</p>
                <p className="text-2xl font-bold text-[#f5f5f5]">{todaysOrders || 24}</p>
